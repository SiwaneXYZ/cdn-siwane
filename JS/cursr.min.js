(function() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===================================
    // دالة للحصول على قيمة CSS variable أو اللون مباشرة
    // ===================================
    ...
    function updateCursor() {
      const border = getColor(cursor_config.cursor_border);
      const fill = getColor(cursor_config.cursor_color);
    ...
    document.addEventListener('mousedown', function(e) {
      ...
      r.style.background = getColor(cursor_config.clicker_color);
      r.style.width = "60px";
      r.style.height = "60px";
