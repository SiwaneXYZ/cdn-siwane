$(document).ready((function() {
    ...
    function loadSeriesLobby(sheet, container, config) {
        ...
        container.html(`<div class="siwane-container"><p class="note"> ${icons.spinner} جاري تحميل القائمة...</p></div>`);
        $.ajax({
    ...
    function playSelectedServer(serverId, params) {
        ...
        $("#siwane-countdown-text").html(`جاري تأمين المشغل...`);
    ...
    function loadServers(params) {
        ...
        grid.html(`<p style="text-align:center;width:100%;">جاري جلب السيرفرات...</p>`);
